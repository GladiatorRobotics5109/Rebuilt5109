package frc.robot.util.fuelsim;
...
public class FuelSim {
     ...
     * @param subticks
     */
    public void setSubticks(int subticks) { FuelSim.subticks = subticks; }
    ...
    /**
     * Registers an intake with the fuel simulator. This intake will remove fuel from the field based on the
     * `ableToIntake` parameter.
     *
